...
export function AboutDialog({ open, onClose }: AboutDialogProps) {
  return (
    <Dialog open={open} onOpenChange={open => { if (!open) onClose(); }}>
      <DialogContent className="max-w-sm bg-card text-card-foreground max-h-[90svh] flex flex-col">
        <DialogHeader>
        ...
        <div className="overflow-y-auto space-y-4">
          ...
          <p className="text-sm text-foreground">Ljudfilerna från Heinz Dropbox har processats så här:</p>
